...
<html>
    ...
    <body>
        ...
        <form method="get" id="nuevaReserva" class="inicioBoton" action="/nuevaReservaAdmin">
            <button type="submit">Nueva Reserva</button>
        </form> 

        <form class="inicioBoton" method="get" action="/vistaVehiculoNuevo">
        ...
        <form method="post" action="/consultarAdmin" class="consultar">
                ...
                <form method="post" action="/finalizarReserva">
                    <c:forEach var="reservasAct" items="${listaAct}">
                        <tr>
                            ...
                            <td><button type="submit" name="reservasAct" value="${reservasAct.id_reserva}">Finalizar Reserva</button></td>
                        </tr>
                    </c:forEach>
                </form>
                </tbody>
